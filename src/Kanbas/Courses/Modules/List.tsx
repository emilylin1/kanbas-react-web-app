...
import "./index.css";
import { FaEllipsisV, FaCheckCircle, FaPlusCircle, FaRegEdit, FaRegTrashAlt } from "react-icons/fa";
        ...
        <>
            <div className="flex-fill">
                ...
                <div className="form-group">
                    ...
                    />
                    <textarea className="form-control" value={module.description} style={{marginBottom: "10px"}}
                        onChange={(e) => dispatch(setModule({ ...module, description: e.target.value }))}
                    />
                    <button type="button" className="btn btn-danger" style={{ marginRight: "5px" }} onClick={() => dispatch(addModule({ ...module, course: courseId }))}>+ Module</button>
                    <button className="btn btn-light-gray" onClick={() => dispatch(updateModule(module))}>Update</button>
                </div>
                <hr />
                        ...
                        <li key={index}
                            ...
                            <div>
                                ...
                                <span className="float-end">
                                    ...
                                    <FaRegEdit className="ms-2" onClick={() => dispatch(setModule(module))}/>
                                    <FaRegTrashAlt className="ms-2" onClick={() => dispatch(deleteModule(module._id))} />
